...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            /* إجبار محتوى main على أخذ العرض الكامل للورقة */
            main { max-width: 100% !important; width: 100% !important; padding: 0 !important; margin: 0 !important; }
            
            /* تحويل الـ Grid إلى Block ليصبح التصميم طولياً إجبارياً */
            ...
            /* إخفاء خلفيات الأيقونات لأنها تظهر سوداء في الطباعة */
            ...
            /* إصلاح الـ Log (الخط الجانبي) في الطباعة */
        ...
        <div class="flex flex-wrap justify-between items-end mb-6 gap-4 print:mb-2">
            <div class="space-y-4 print:space-y-1">
                ...
                <div class="flex items-center gap-3 print:block">
                    ...
                    <span class="bg-blue-900/30 text-blue-400 text-xs px-3 py-1 rounded-full border border-blue-800/50 print:border-none print:p-0 print:text-black">#{{ $purchase->id }}</span>
                ...
                <p class="text-gray-500 text-xs print:text-black">Generated on {{ \Carbon\Carbon::parse($purchase->created_at)->format('M d, Y — h:i A') }}</p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="card p-6 rounded-[1.5rem]">
                    <h3 class="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-6 border-b border-gray-800 pb-2 print:border-black print:text-black">Information</h3>
                    <div class="grid grid-cols-2 gap-8 print:gap-2">
                        <div>
                            <p class="text-[10px] text-gray-500 uppercase mb-1 print:text-black">Invoice Number</p>
                            <p class="accent-blue font-bold print:text-black">#{{ $purchase->id }}</p>
                        </div>
                        <div>
                            <p class="text-[10px] text-gray-500 uppercase mb-1 print:text-black">Purchase Date</p>
                            <p class="text-sm font-semibold print:text-black">{{ \Carbon\Carbon::parse($purchase->purchase_date)->format('F d, Y') }}</p>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-blue-900/20 rounded-lg flex items-center justify-center text-blue-400 no-print">
                                <i class="far fa-user"></i>
                            </div>
                            <div>
                                <p class="text-[10px] text-gray-500 uppercase print:text-black">Supplier</p>
                                <p class="text-sm font-bold print:text-black">{{ $purchase->supplier_name }}</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-cyan-900/20 rounded-lg flex items-center justify-center text-cyan-400 no-print">
                                <i class="fas fa-warehouse text-xs"></i>
                            </div>
                            <div>
                                <p class="text-[10px] text-gray-500 uppercase print:text-black">Warehouse</p>
                ...
                <div class="card p-6 rounded-[1.5rem] overflow-x-auto">
                    <h3 class="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-6 border-b border-gray-800 pb-2 print:border-black print:text-black">Items List</h3>
                    <table class="w-full text-left">
                        <thead>
                            <tr class="text-[10px] text-gray-500 uppercase print:text-black">
                        ...
                        <tbody class="text-sm">
                            ...
                            <tr class="border-t border-gray-800/50 print:border-black">
                                <td class="py-4 flex items-center gap-3 print:py-2">
                                    <div class="w-10 h-10 bg-blue-900/10 rounded-lg border border-blue-900/30 flex items-center justify-center text-blue-400 no-print">
                                        <i class="fas fa-cube text-xs"></i>
                                    </div>
                                    <p class="font-semibold print:text-xs">{{ $item->product_name }}</p>
                                </td>
                                <td class="text-gray-500 no-print">{{ $item->barcode }}</td>
                                <td class="text-center">
                                    <span class="bg-blue-900/40 px-2 py-1 rounded text-xs print:bg-none print:text-black">{{ $item->quantity }}</span>
                                </td>
                                <td class="no-print">{{ number_format($item->price, 2) }}</td>
            ...
            <div class="space-y-6">
                <div class="card p-6 rounded-[1.5rem]">
                    <h3 class="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-6 border-b border-gray-800 pb-2 print:border-black print:text-black">Financial Summary</h3>
                    <div class="space-y-4 text-sm">
                        ...
                        <div class="flex justify-between border-b border-gray-800 pb-4 print:border-black">
                        ...
                        <div class="flex justify-between items-center pt-2">
                            ...
                            <span class="text-xl font-bold print:text-sm print:text-black">{{ number_format($purchase->total_amount, 2) }} DZD</span>
                        </div>
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-bold {{ $purchase->remaining_amount > 0 ? 'text-red-500' : 'text-gray-500' }} print:text-black">
                ...
                <div class="card p-6 rounded-[1.5rem]">
                    <h3 class="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-6 border-b border-gray-800 pb-2 print:border-black print:text-black">System Log</h3>
                    <div class="relative space-y-8 before:absolute before:inset-0 before:ml-[13px] before:h-full before:w-0.5 before:bg-gray-800 print:before:bg-gray-300">
                        <div class="relative flex items-start gap-4">
                            <div class="relative z-10 w-7 h-7 bg-blue-900/40 rounded-full border border-blue-500/50 flex items-center justify-center text-[10px] text-blue-400 print:bg-white print:text-black print:border-black">
                                <i class="fas fa-file-invoice"></i>
                            </div>
                            <div>
                                <p class="text-sm font-bold leading-none print:text-black">Invoice Created</p>
                                <p class="text-[10px] text-gray-500 mt-1 print:text-black">
