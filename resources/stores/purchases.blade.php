...
@push('styles')
<style>
    /* تنسيقات خاصة بعملية الطباعة فقط */
    @media print {
        /* 1. إخفاء العناصر التي لا نحتاجها في الورقة */
        #sidebar, 
        #toggleSidebar, 
        .nav-bar, 
        .no-print,
        ...
        /* 2. تمديد المحتوى ليأخذ كامل مساحة الورقة */
        #main-content, 
        main, 
        .container,
        body {
        ...
        /* إخفاء عمود الإجراءات بالكامل عند الطباعة */
        th:last-child, 
        td:last-child {
            display: none !important;
        }

        /* إظهار الأرقام والعملات بوضوح */
...
<div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4 bg-white dark:bg-[#0f172a] p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm transition-colors duration-300">
    ...
    <div class="flex flex-wrap gap-3 w-full md:w-auto">
        <button onclick="window.print()" 
            class="flex-1 md:flex-none bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 px-6 py-3 rounded-xl font-bold transition duration-300 flex items-center justify-center gap-2 border border-gray-200 dark:border-gray-700 hover:bg-gray-200 dark:hover:bg-gray-700">
        ...
        <a href="{{ route('purchases.create') }}"
            class="flex-1 md:flex-none bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-bold transition duration-300 flex items-center justify-center gap-2 shadow-lg shadow-blue-600/20">
        ...
        <table class="w-full text-right border-collapse">
            <thead>
                <tr class="bg-gray-50 dark:bg-[#020617] text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider">
                    ...
                    <th class="px-6 py-4 font-bold text-center no-print">الإجراءات</th>
                </tr>
            </thead>
                ...
                <tr class="hover:bg-gray-50/50 dark:hover:bg-white/5 transition-colors group">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center no-print">
